<template>
    <div id="app">
        <div v-if="!loaded" class="loading" ref="loading">
            <MTPEVideo class="video" src="/static/loading.mp4" animation="/static/loading/MTP_Logo__$.png"
                :animationCount="75" :cursorEffect="false" :forceAnimation="true" :animationSpeed="0.2"
                @ended="endLoading" />
        ...
        <svg class="cursor" width="90" height="90" viewBox="0 0 140 140">
            <defs>
                <filter id="filter-1" x="-50%" y="-50%" width="200%" height="200%" filterUnits="objectBoundingBox">
                    ...
                    <feDisplacementMap xChannelSelector="R" yChannelSelector="G" scale="60" in="SourceGraphic"
                        in2="warp" />
                </filter>
            </defs>
